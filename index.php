         ...
         <div class="error">
            ...
            if (!$cookieset
                ...
                if (($motd = file_get_contents(MOTDFILE)) !== FALSE && strlen(trim($motd)) > 0) {
                    echo '
                <div id="motd" class="col-md-9 alert alert-info alert-dismissible fade show" role="alert">
...
// Execute when htmx swaps content (since stats/users update dynamically)
