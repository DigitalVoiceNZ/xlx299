...
$PageOptions['ModuleNames']['B']                     = 'FreeDMR-530-MMDV Peanut';
$PageOptions['ModuleNames']['C']                     = 'USA XLX315';
$PageOptions['ModuleNames']['D']                     = 'DRats SSTV-BM-TG530';
$PageOptions['ModuleNames']['E']                     = 'M-17 Bridge';
$PageOptions['ModuleNames']['F']                     = 'ZL2 Regional FD5302';
...
$PageOptions['ModuleNames']['K']                     = 'Chit-chat FD53029';
...
$PageOptions['ModuleIcons']['B']                     = './img/FreeDMR-130.gif';
$PageOptions['ModuleIcons']['C']                     = './img/usa.jpg';
$PageOptions['ModuleIcons']['D']                     = './img/brandmeister-130.png';
$PageOptions['ModuleIcons']['R']                     = './img/modules/roar.jpg';
$PageOptions['ModuleIcons']['E']                     = './img/kiwi_radio.png';
$PageOptions['ModuleIcons']['F']                     = './img/FreeDMR-130.gif';
$PageOptions['ModuleIcons']['G']                     = './img/Snoopy.jpg';
$PageOptions['ModuleIcons']['H']                     = './img/anzel-130.gif';
$PageOptions['ModuleIcons']['I']                     = './img/FreeDMR-130.gif';
$PageOptions['ModuleIcons']['J']                     = './img/kiwi_radio.png';
$PageOptions['ModuleIcons']['K']                     = './img/FreeDMR-130.gif';
//$PageOptions['ModuleIcons']['L']                     = '';
//$PageOptions['ModuleIcons']['M']                     = 'Manawatu / Wanganui';
$PageOptions['ModuleIcons']['N']                     = './img/kiwi_radio.png';
$PageOptions['ModuleIcons']['O']                     = './img/zltrbo-130.gif';
$PageOptions['ModuleIcons']['P']                     = './img/globe.jpg';
$PageOptions['ModuleIcons']['Q']                     = './img/globe.jpg';
$PageOptions['ModuleIcons']['R']                     = './img/ROAR2.jpg';
$PageOptions['ModuleIcons']['S']                     = './img/brandmeister-130.png';
$PageOptions['ModuleIcons']['T']                     = './img/FreeDMR-130.gif';
$PageOptions['ModuleIcons']['U']                     = './img/uk.png';
$PageOptions['ModuleIcons']['V']                     = './img/FreeDMR-130.gif';
$PageOptions['ModuleIcons']['W']                     = './img/FreeDMR-130.gif';
$PageOptions['ModuleIcons']['X']                     = './img/FreeSTAR-130.jpg';
$PageOptions['ModuleIcons']['Y']                     = './img/globe.jpg';
